...
function KeyPad(props) {
  ...
  return (
    <div className="buttons">
        <div className="one">
          <button id='clear' className="clear" data-testid='clear' onClick={clearClick}>C</button>
        </div>
        <div className="two">
          ...
          <button  id="operator-divide" data-testid='operator_divide' onClick={() => operatorClick('/')}>/</button>
          ...
          <button id="operator-multiply" data-testid='operator_multiply'  onClick={() => operatorClick('*')}>x</button>
          ...
          <button id="operator-subtract" data-testid='operator_subtract'  onClick={() => operatorClick('-')}>-</button>
          <button id="decimal" data-testid='decimal'  onClick={() => decimalClick()}>.</button>
          <button data-testid="number0" id="number0" onClick={() => numberClick('0')}>0</button>
          <button id="operator-equals" data-testid='operator_equals' onClick={() => operatorClick('=')}>=</button>
          <button id="operator_add" data-testid='operator_add' onClick={() => operatorClick('+')}>+</button>
        </div>
        </div>
  );
}
